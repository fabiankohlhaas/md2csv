...
if __name__ == "__main__":
    markdown_filename = "input.md" #input("Please enter the path of the Markdown file: ")
    csv_filename = "import-to-anki.csv" #input("Please enter the path of the CSV file to be created: ")
